    ...
    for i in range(columnsSubplots):
        ...
        if i%2 ==0: 
            ...
            if i==1:   
                ...
                if type == 'FAC':
                    plotDir1 = '/Users/cathymartin/Desktop/DickBiscuit'
                    FAC = np.load(os.path.join(plotDir1, '80_3.npy'))
                    dateB1 = FAC[0]
                    diameterB1 = FAC[1]
                    fitB1 = FAC[2]
                    FACB1 = FAC[3]
...
#         Z = np.transpose(Z)
        if type == 'FAC':
            ...
            if i==1:
                ...
                ax.set_ylim(0.0022,0.0024)
                for i in range(len(diameterB1)):
                    if abs(diameterB1[i]-fitB1[i]) >= 0.00004:
                        print diameterB1[i]
                        diameterB1[i] = fitB1[i]
                        print diameterB1[i]
                #         
                    else:
                        pass
...
plt.savefig('Series4AutoCon.png')
print 'saved'
# toc = time.clock()
# print toc-tic
plt.cla()